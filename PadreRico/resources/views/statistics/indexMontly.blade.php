                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="mb-3">
                            ...
                            <span>{{ number_format($statistics->general_balance - $statistics->income_total + $statistics->outcome_total, 2, ',', '.') }}
                                €</span>
                        </div>
                        <div class="mb-3">
                        ...
                        @if ($statistics->income_total > $statistics->outcome_total)
                            <div class="alert alert-success py-2">
                                <i class="bi bi-emoji-smile"></i> ¡Has ganado más de lo que has gastado este mes! Vamos
                                ahorrando.
                            </div>
                        @elseif($statistics->income_total < $statistics->outcome_total)
                            <div class="alert alert-warning py-2">
                                <i class="bi bi-exclamation-triangle"></i> Has gastado más de lo que has ganado este mes.
                                ¡Cuidado!
                            </div>
                        @else
                            <div class="alert alert-info py-2">
                                <i class="bi bi-balance-scale"></i> Has gastado y ganado la misma cantidad este mes. En
                                perfecto equilibrio.
                            </div>
                        @endif
                        <div class="mb-3 mt-4">
                        ...
                        <div class="mb-3">
                            ...
                            <span
                                class="text-capitalize">{{ \Carbon\Carbon::parse($statistics->most_spending_day)->locale('es')->isoFormat('dddd, D [de] MMMM') }}</span>
                            <br>
