...
@section('content')
    <div class="container py-4">
        <div class="card shadow-sm">
            <div class="card-body">
                <h1 class="mb-4 text-center display-4">Estadísticas del {{ ucfirst($mes) }} de {{ $anio }}</h1>
                <div class="row g-4">
                    <!-- Columna de datos -->
                    <div class="col-md-6">
                        <div class="d-flex flex-column gap-3">
                            <div class="card border-secondary shadow-sm">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="fs-5">
                                            {{ number_format($statistics->general_balance - $statistics->income_total + $statistics->outcome_total, 2, ',', '.') }}
                                            €</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card border-primary shadow-sm">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="fs-5">{{ number_format($statistics->income_total, 2, ',', '.') }} €
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card border-danger shadow-sm">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="fs-5">{{ number_format($statistics->outcome_total, 2, ',', '.') }} €
                                        </div>
                                    </div>
                                </div>
                            </div>
                            @if ($statistics->income_total > $statistics->outcome_total)
                                <div class="alert alert-success py-2 d-flex align-items-center">
                                    ...
                                    <span>¡Has ganado más de lo que has gastado este mes! Vamos ahorrando.</span>
                                </div>
                            @elseif($statistics->income_total < $statistics->outcome_total)
                                <div class="alert alert-warning py-2 d-flex align-items-center">
                                    ...
                                    <span>Has gastado más de lo que has ganado este mes. ¡Cuidado!</span>
                                </div>
                            @else
                                <div class="alert alert-info py-2 d-flex align-items-center">
                                    <i class="bi bi-balance-scale fs-4 me-2"></i>
                                    <span>Has gastado y ganado la misma cantidad este mes. En perfecto equilibrio.</span>
                                </div>
                            @endif
                            <div class="card border-success shadow-sm">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="fs-5">{{ number_format($statistics->general_balance, 2, ',', '.') }} €
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card border-warning shadow-sm">
                                <div class="card-body">
                                    <div class="fw-bold mb-1"><i class="bi bi-calendar2-week text-warning me-2"></i>Día más
                                        derrochador
                                    </div>
                                    <div class="mb-1 text-capitalize">
                                        {{ \Carbon\Carbon::parse($statistics->most_spending_day)->locale('es')->isoFormat('dddd, D [de] MMMM') }}
                                    </div>
                    ...
                    <div class="col-md-6 d-flex flex-column align-items-center">
                        <div class="card w-100 shadow-sm">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <canvas id="outcomeCategoryChart" style="max-width:300px;max-height:300px;"></canvas>
